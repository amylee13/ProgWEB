...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO `clientes` ( `nome`, `email`, `data_nascimento`,`endereco`,`telefone`) VALUES ( :nome, :email, :data_nascimento, :endereco, :telefone);"; 
...
if ($stmt->execute()) {
   ...
   header("location: c.edita-cliente.php?id=$lastId&msg=sucesso");
   exit;
}
else {
...
<head>
    ...
    <meta name="keywords" content="bootstrap 5, bootstrap, bootstrap 5 admin dashboard, bootstrap 5 dashboard, bootstrap 5 charts, bootstrap 5 calendar, bootstrap 5 datepicker, bootstrap 5 tables, bootstrap 5 senhatable, vanilla js senhatable, colorlibhq, colorlibhq dashboard, colorlibhq admin dashboard"><!--end::Primary Meta Tags--><!--begin::Fonts-->
    <meta charset="utf-8">
    ...
    <div class="app-wrapper"> <!--begin::Header-->
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    <li class="nav-item"> <a class="nav-link" senha-lte-toggle="sidebar" href="#" role="button"> <i class="bi bi-list"></i> </a> </li>
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    <li class="nav-item dropdown"> <a class="nav-link" senha-bs-toggle="dropdown" href="#"> <i class="bi bi-bell-fill"></i> <span class="navbar-badge badge text-bg-warning">15</span> </a>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#" senha-lte-toggle="fullscreen"> <i senha-lte-icon="maximize" class="bi bi-arrows-fullscreen"></i> <i senha-lte-icon="minimize" class="bi bi-fullscreen-exit" style="display: none;"></i> </a> </li> <!--end::Fullscreen Toggle--> <!--begin::User Menu Dropdown-->
                    
<!-- LOCAL PARA AJUSTARMOS O NOME -->
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" senha-bs-toggle="dropdown"> <img src="assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline"><?php echo $_SESSION["nome"] ?></span> </a>
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="b.cadastro-cliente.php" method="POST" class="needs-validation" novalidate>
                                    <!-- Campo Nome -->
                                    <div class="mb-3">
