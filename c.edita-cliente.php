...
if (empty($_GET["id"])) {
    header("Location: a.lista-cliente.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE clientes SET nome = :nome, email = :email, data_nascimento = :data_nascimento, endereco = :endereco, telefone = :telefone WHERE id = :id";
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="c.edita-cliente.php?id=<?php echo $user['id']?>" method="POST" class="needs-validation"novalidate>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="d.exclui-cliente.php?id=<?php echo htmlspecialchars($user['id']); ?>" 
